...
const exactRuntimeCopy = {
  ...
  "Use the live displacement relation": "使用即時位移關係式",
  "The current phase angle is": "目前相位角為",
  ", so the displacement becomes": "，因此位移變成",
  "Angular speed": "角速度",
  ...
  "Readout": "讀數",
  "Projection readout": "投影讀數",
  "Delay to the probe = 1 s.": "到探頭的延遲 = 1 s。",
  "Phase lag = 1.5 cycles (opposite-phase).": "相位落後 = 1.5 個週期（反相）。",
  "One period of travel covers 1.6 m.": "一個週期的傳播距離是 1.6 m。",
  "Carrier frequency f_avg = 1.06 Hz.": "載波頻率 f_avg = 1.06 Hz。",
  "The loudness pulse repeats every 8.33 s because the frequency split is 0.12 Hz.": "響度脈衝每 8.33 s 重複一次，因為頻率差是 0.12 Hz。",
  "This bounded bench stays in the nearby-frequency regime where one swelling and fading sound is a useful perception model.": "這個有界實驗台保持在相近頻率範圍，讓一個漸強又漸弱的聲音能作為有用的感知模型。",
  "Front spacing = 2.41 m; rear spacing = 3.41 m.": "前方間距 = 2.41 m；後方間距 = 3.41 m。",
  "Current separation = 3.7 m; travel delay = 1.4 s.": "目前距離 = 3.7 m；傳播延遲 = 1.4 s。",
  "Current separation = 3.71 m; travel delay = 1.4 s.": "目前距離 = 3.71 m；傳播延遲 = 1.4 s。",
  "Source motion changes medium spacing, while observer motion changes the arrival rate on the chosen side.": "聲源運動改變介質中的間距，觀察者運動則改變所選一側的到達率。",
  "Open-open tubes allow every integer harmonic, so each resonance order steps to the next whole-number harmonic.": "開口-開口管允許每個整數諧波，所以每個共鳴階次都前進到下一個整數諧波。",
  "Probe motion envelope = 0.08 m at a between point.": "探頭運動包絡 = 0.08 m，位於中間點。",
  "Pressure envelope = 0.08 m and swaps roles with the parcel-motion pattern.": "壓力包絡 = 0.08 m，並與粒子運動圖樣互換角色。",
  "After the push, the redistributed momenta persist because the system never received an external impulse.": "推動之後，重新分配的動量會保持下去，因為系統沒有收到外部衝量。",
  "Track the flat total-momentum line and the steady center-of-mass drift together.": "一起追蹤平直的總動量線和穩定的質心漂移。",
  "Drag is now nearly balancing weight": "阻力目前幾乎正在平衡重量",
  "Real image can land on a screen.": "實像可以落在螢幕上。",
  "Live imaging bench": "即時成像實驗台",
  "distant pair": "遠方雙點",
  "finite aperture": "有限孔徑",
  "image plane": "像平面",
  "Resolution state": "解析度狀態",
  "Delta theta": "Delta θ",
  "ratio": "比例",
  "The current pair is still below the Rayleigh threshold, so the central dip has mostly filled in.": "目前雙點仍低於 Rayleigh 門檻，所以中央凹位大多被填平。",
  "The pair is near the Rayleigh threshold, so the split is just beginning to show.": "雙點接近 Rayleigh 門檻，所以分離剛開始顯現。",
  "The pair now sits above the Rayleigh threshold, so a distinct dip separates the peaks.": "雙點已高於 Rayleigh 門檻，所以清楚的凹位把兩個峰分開。",
  "Airy radius on the image plane is about 33.55 um while the point spacing is 33.6 um.": "像平面上的 Airy 半徑約為 33.55 um，而點距約為 33.6 um。",
  "Quadrant II": "第二象限",
  "Quadrant II: cos < 0, sin > 0.": "第二象限：cos < 0，sin > 0。",
  "cos = x on the horizontal axis.": "cos = x，位於水平軸。",
  "sin = y on the vertical axis.": "sin = y，位於垂直軸。",
  "larger value": "較大值",
  "pass end": "回合末端",
  "scan": "掃描",
  "center ray": "中心光線",
