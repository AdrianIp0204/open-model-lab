...
export const chemistryReactionGraphLayout: ChemistryGraphLayout = {
  ...
  nodePositions: {
    alkene: { x: 80, y: 120 },
    haloalkane: { x: 80, y: 620 },
    alcohol: { x: 540, y: 370 },
    aldehyde: { x: 940, y: 118 },
    ketone: { x: 940, y: 620 },
    "carboxylic-acid": { x: 1260, y: 108 },
    ester: { x: 1260, y: 620 },
  },
  edgeCurves: {
    "alkene-to-alcohol-hydration": -96,
    "alkene-to-haloalkane-hydrohalogenation": 132,
    "haloalkane-to-alcohol-hydrolysis": -96,
    "alcohol-to-haloalkane-substitution": 96,
    "alcohol-to-aldehyde-oxidation": -88,
    "alcohol-to-ketone-oxidation": 88,
    "aldehyde-to-carboxylic-acid-oxidation": -48,
    "aldehyde-to-alcohol-reduction": 92,
    "ketone-to-alcohol-reduction": -92,
    "carboxylic-acid-to-ester-esterification": 96,
    "ester-to-carboxylic-acid-hydrolysis": -96,
  },
  edgeLabelOffsets: {
    "alkene-to-alcohol-hydration": { x: -38, y: -54 },
    "alkene-to-haloalkane-hydrohalogenation": { x: -50, y: 54 },
    "haloalkane-to-alcohol-hydrolysis": { x: -54, y: -52 },
    "alcohol-to-haloalkane-substitution": { x: 54, y: 52 },
    "alcohol-to-aldehyde-oxidation": { x: 34, y: -68 },
    "aldehyde-to-alcohol-reduction": { x: -34, y: 68 },
    "alcohol-to-ketone-oxidation": { x: 34, y: 68 },
    "ketone-to-alcohol-reduction": { x: -34, y: -68 },
    "aldehyde-to-carboxylic-acid-oxidation": { x: -8, y: -62 },
    "carboxylic-acid-to-ester-esterification": { x: 46, y: -58 },
    "ester-to-carboxylic-acid-hydrolysis": { x: -46, y: 58 },
  },
};
