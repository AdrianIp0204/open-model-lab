...
export const chemistryReactionGraphLayout: ChemistryGraphLayout = {
  ...
  edgeLabelOffsets: {
    "alkene-to-alcohol-hydration": { x: -50, y: -62 },
    "alkene-to-haloalkane-hydrohalogenation": { x: -70, y: 66 },
    "haloalkane-to-alcohol-hydrolysis": { x: -66, y: -62 },
    "alcohol-to-haloalkane-substitution": { x: 70, y: 62 },
    "alcohol-to-aldehyde-oxidation": { x: 42, y: -76 },
    "aldehyde-to-alcohol-reduction": { x: -42, y: 76 },
    "alcohol-to-ketone-oxidation": { x: 42, y: 76 },
    "ketone-to-alcohol-reduction": { x: -42, y: -76 },
    "aldehyde-to-carboxylic-acid-oxidation": { x: -12, y: -66 },
    "carboxylic-acid-to-ester-esterification": { x: 58, y: -66 },
    "ester-to-carboxylic-acid-hydrolysis": { x: -58, y: 66 },
  },
};
