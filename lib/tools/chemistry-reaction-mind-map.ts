...
export const chemistryReactionGraphLayout: ChemistryGraphLayout = {
  ...
  nodePositions: {
    alkene: { x: 64, y: 120 },
    haloalkane: { x: 84, y: 404 },
    alcohol: { x: 400, y: 258 },
    aldehyde: { x: 726, y: 96 },
    ketone: { x: 726, y: 404 },
    "carboxylic-acid": { x: 948, y: 86 },
    ester: { x: 948, y: 404 },
  },
  edgeCurves: {
    "alkene-to-alcohol-hydration": -56,
    "alkene-to-haloalkane-hydrohalogenation": 84,
    "haloalkane-to-alcohol-hydrolysis": -48,
    "alcohol-to-haloalkane-substitution": 48,
    "alcohol-to-aldehyde-oxidation": -48,
    "alcohol-to-ketone-oxidation": 48,
    "aldehyde-to-carboxylic-acid-oxidation": 0,
    "aldehyde-to-alcohol-reduction": 48,
    "ketone-to-alcohol-reduction": -48,
    "carboxylic-acid-to-ester-esterification": 72,
    "ester-to-carboxylic-acid-hydrolysis": -72,
  },
  edgeLabelOffsets: {
    "haloalkane-to-alcohol-hydrolysis": { x: -24, y: 30 },
    "alcohol-to-haloalkane-substitution": { x: 24, y: -30 },
    "alcohol-to-aldehyde-oxidation": { x: 0, y: -28 },
    "aldehyde-to-alcohol-reduction": { x: 0, y: 28 },
    "alcohol-to-ketone-oxidation": { x: 0, y: -28 },
    "ketone-to-alcohol-reduction": { x: 0, y: 28 },
    "carboxylic-acid-to-ester-esterification": { x: 0, y: -24 },
    "ester-to-carboxylic-acid-hydrolysis": { x: 0, y: 24 },
  },
};
