...
export const chemistryReactionGraphLayout: ChemistryGraphLayout = {
  ...
  edgeLabelOffsets: {
    "alkane-to-haloalkane-radical-substitution": { x: -80, y: 50 },
    ...
    "aldehyde-to-hydroxynitrile-cyanohydrin-addition": { x: 0, y: 185 },
    "ketone-to-hydroxynitrile-cyanohydrin-addition": { x: -86, y: 138 },
    ...
    "carboxylic-acid-to-carboxylate-salt-neutralisation": { x: -78, y: 64 },
    "carboxylic-acid-to-acyl-chloride-chlorination": { x: -20, y: -82 },
    "acyl-chloride-to-ester-alcoholysis": { x: 118, y: 168 },
    "acyl-chloride-to-amide-ammonolysis": { x: -92, y: 10 },
    "ester-to-carboxylic-acid-hydrolysis": { x: -80, y: 88 },
    "ester-to-carboxylate-salt-alkaline-hydrolysis": { x: -40, y: -100 },
  },
};
