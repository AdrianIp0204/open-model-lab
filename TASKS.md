...
- [ ] **OML-QA-032: Remove the unsafe zh-HK visible-text fallback that rewrites unknown English into `項目`.**
...
- [ ] **OML-QA-033: Restore a genuinely green zh-HK overlay validation state before claiming the deployment is translated.**
...
- [ ] **OML-QA-034: Add a semantic zh-HK browser QA gate instead of only checking for English leaks.**
...
- [ ] **OML-QA-035: Run and enforce a full light-mode vs dark-mode visual contrast sweep across the site.**
...
- [ ] **OML-QA-036: Localize accessibility names, aria labels, and control metadata, not only visible text.**
...
- [ ] **OML-QA-037: Add deployed-site release verification that checks the live URL, not only local dev.**
...
- [ ] **OML-QA-038: Repair remaining zh-HK copy quality on footer/contact/account/support surfaces after removing the fallback localizer.**
