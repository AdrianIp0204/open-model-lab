...
- [ ] **OML-QA-017: Make guided rail quick checks genuinely interactive or stop making them look like answerable checks.**
...
- [ ] **OML-QA-018: Expose or deliberately retire Compare mode on guided concept pages.**
...
- [ ] **OML-QA-019: Turn buried prediction, overlay, and equation-map support into contextual bench tools.**
...
- [ ] **OML-QA-020: Reduce first-viewport text density and card count on concept pages.**
...
- [ ] **OML-QA-021: Improve mobile simulation visual readability before adding more text.**
