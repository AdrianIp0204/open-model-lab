    ...
    <section className="space-y-3 sm:space-y-4">
      <header className="page-band grid gap-3 p-3 sm:p-4 lg:grid-cols-[minmax(0,1fr)_6rem] lg:items-center">
        ...
        <a
          ...
          className="hidden w-24 rounded-[18px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink-950/20 focus-visible:ring-offset-2 focus-visible:ring-offset-paper lg:block"
        >
      ...
      >
        ...
        >
          <div className="flex min-w-0 flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex min-w-0 flex-nowrap items-center gap-1.5 overflow-x-auto [scrollbar-width:thin] [&>*]:shrink-0">
              <span
                ...
                className="rounded-full border border-teal-500/25 bg-teal-500/10 px-2.5 py-1.5 text-xs font-medium text-teal-900"
              >
                {selectionSummary}
              </span>
              {comparison ? (
          ...
          <div className="min-[1100px]:row-start-2 min-[1100px]:min-h-0 min-[1100px]:overflow-hidden">
